...
async def test_full_daily_workflow(ledger):
    ...
    items_data = [
        ("item_001", "menu_steak", "NY Strip Steak", Decimal("45.00"), "food"),
        ("item_002", "menu_wine", "Glass of Cabernet", Decimal("14.00"), "wine"),
    ]
    ...
    assert order1.balance_due == Decimal("0.00")
    ...
    items2 = [
        ("item_003", "menu_burger", "Wagyu Burger", Decimal("28.00"), "food"),
        ("item_004", "menu_salad", "Caesar Salad", Decimal("16.00"), "food"),
        ("item_005", "menu_beer", "IPA Draft", Decimal("9.00"), "beer"),
        ("item_006", "menu_beer", "IPA Draft", Decimal("9.00"), "beer"),
    ]
    ...
    assert card_payment.tip_amount == Decimal("12.40")
    ...
    assert Decimal(str(tip_events[0].payload["tip_amount"])) == Decimal("12.40")
